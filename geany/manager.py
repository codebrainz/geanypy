...
class PluginManager(gtk.Dialog):
	...
	def on_plugin_activate(self, obj, plugin, data=None):
		print "PluginManager forwarding 'plugin-activate' signal."
		self.emit('plugin-activate', plugin)
	def on_plugin_deactivate(self, obj, plugin, data=None):
		print "PluginManager forwarding 'plugin-deactivate' signal."
	...
	def __init__(self, plugin_dirs=[]):
		...
		self.loader.connect('plugin-activate', self.on_plugin_activate)
		self.loader.connect('plugin-deactivate', self.on_plugin_deactivate)
