...
{
	const gchar *name = editor_get_eol_char_name(self->editor);
	if (name != NULL)
...
static PyObject *
Editor_set_indent_type(Editor *self, PyObject *args, PyObject *kwargs)
{
	gint indent_type;
	static gchar *kwlist[] = { "type", NULL };
	if (PyArg_ParseTupleAndKeywords(args, kwargs, "i", kwlist, &indent_type))
...
static PyObject *
Editor_get_scintilla(Editor *self)
{
	Scintilla *sci;
	if (self->editor != NULL)
	{
...
static PyMethodDef Editor_methods[] = {
	...
	{ "get_eol_char", (PyCFunction) Editor_get_eol_char, METH_NOARGS },
	{ "get_eol_char_name", (PyCFunction) Editor_get_eol_char_name, METH_NOARGS },
	{ "get_indent_prefs", (PyCFunction) Editor_get_indent_prefs, METH_NOARGS },
	{ "set_indent_type", (PyCFunction) Editor_set_indent_type, METH_NOARGS },
	{ "get_scintilla", (PyCFunction) Editor_get_scintilla, METH_NOARGS },
	{ NULL }
};
...
init_geany_editor(void)
{
	...
	m = Py_InitModule("_editor", EditorModule_methods);
